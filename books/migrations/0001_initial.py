    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_cover_image', cloudinary.models.CloudinaryField(help_text='Upload book cover image', max_length=255, null=True, verbose_name='image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='books.bookdownload')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
